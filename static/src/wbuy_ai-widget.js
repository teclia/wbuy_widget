...
(function () {
    ...
    const allowedOrigins = ["https://widget.wbuy.ai"];
    ...
    fetch(`https://server.wbuy.ai/robots/${wbuy_ai_wbuy_aiId}.json`)
        .then(response => response.json())

        .then(wbuy_ai_config => {

            const wbuy_ai_buttonImage = wbuy_ai_config.buttonImage || "https://widget.wbuy.ai/img/wbuy_ai_icon.png";
            ...
            function trackPageUrlChanges() {
                ...
                function sendUrlToIframe(newUrl) {
                    ...
                    if (wbuy_ai_iframe) {
                        wbuy_ai_iframe.contentWindow.postMessage({ action: "PAGE_URL_RESPONSE", url: newUrl }, "https://widget.wbuy.ai");
                    }
                }
            ...
            const wbuy_ai_openIframe = () => {
                ...
                //wbuy_ai_iframe.src = `https://widget.wbuy.ai/${wbuy_ai_wbuy_aiId}`;
                wbuy_ai_iframe.src = `https://widget.wbuy.ai/${wbuy_ai_wbuy_aiId}?${queryString}`;
                ...
                wbuy_ai_closeButton.addEventListener("click", () => {
                    ...
                    wbuy_ai_iframe.contentWindow.postMessage({ action: "closeChat" }, "https://widget.wbuy.ai");
                ...
                setTimeout(() => {
                    ...
                    if (lastUrl) {
                        wbuy_ai_iframe.contentWindow.postMessage({ action: "PAGE_URL_RESPONSE", url: lastUrl }, "https://widget.wbuy.ai");
                    }
                }, 1500);
